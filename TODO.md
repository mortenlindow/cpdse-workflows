...
Live, actionable items. The full backlog lives in CLAUDE.md ("What is NOT done yet").

## Reference models
- [ ] Pharma Value Chain: fill the 7 substep stubs as engagements encounter them.
- [ ] Pharma Value Chain: add the 3 oligo-specific items (GalNAc delivery
      specifics; RNA secondary-structure tools in Lead Identification; NABM
      multi-scale mechanistic modelling in Clinical Pharmacology).
- [ ] Formalise the **stage → competency** intersection map (currently flagged as
      per-engagement only in `reference/README.md`).
